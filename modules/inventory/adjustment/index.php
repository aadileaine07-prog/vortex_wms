    ...
    <div class="container-fluid p-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
            <div>
                <h2 class="fw-bold text-dark mb-1">
                    <i class="fa-solid fa-boxes-packing text-primary me-2"></i>Stock Adjustment
                </h2>
                <p class="text-muted mb-0">Increase / Decrease Inventory Stock Quantity</p>
            </div>
            <div>
        ...
        <div class="card shadow-sm border-0 rounded-3">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-primary px-2 py-1 fs-6"><?= $row['quantity']; ?></span>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="delete.php?id=<?= $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Delete this adjustment history?');"><i class="fa-solid fa-trash"></i></a>
                                        </td>
                                    </tr>
                            <?php
                                }
            ...
            <div class="card-footer bg-light d-flex justify-content-between align-items-center p-3">
                <a href="../index.php" class="btn btn-outline-secondary"><i class="fa-solid fa-arrow-left me-1"></i> Inventory</a>

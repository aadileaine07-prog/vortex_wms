...
/* ==========================================================================
   1. DYNAMIC TABLE & COLUMN DETECTION
   ========================================================================== */
...
<div class="container-fluid p-0">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <div>
            ...
            <p class="text-muted mb-0">Track manual inventory adjustments, audit surplus & deficit corrections</p>
        </div>
                        ...
                        <?php if ($result && mysqli_num_rows($result) > 0): ?>
                            <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <small class="text-dark fw-semibold text-truncate d-inline-block" style="max-width: 180px;" title="<?= htmlspecialchars($row['reason']); ?>">
                                            <?= htmlspecialchars($row['reason'] ?: 'Audit Recount'); ?>
                                        </small>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-inline-flex gap-1">
                                            ...
                                            <a href="delete.php?id=<?= $row['id']; ?>" class="btn btn-outline-danger btn-sm rounded-circle" onclick="return confirm('⚠️ Are you sure? Reverting this adjustment will alter stock balances!');" title="Revert & Delete"><i class="fa-solid fa-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        <?php else: ?>
                            <tr>
                                <td colspan="9" class="text-center py-5 text-muted">
                                    ...
                                    No stock adjustment records found. Click <strong>New Adjustment</strong> to log inventory changes.
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function applyFilter() {
        ...
        const typeVal   = typeFilter ? typeFilter.value.toLowerCase().trim() : "";

<! wellcome to the dashboard module. This module provides an overview of key metrics and information related to the system. It includes various widgets and charts that display data in a visually appealing manner. Users can customize their dashboard by adding or removing widgets based on their preferences. The dashboard is designed to be user-friendly and responsive, ensuring a seamless experience across different devices.><?php
